...
public class CityUtilTest {
    ...
    public void allCities_WeatherLessThan40(){
        ...
        //Fails
//        when(cityService.getAll()).thenReturn(Arrays.asList(new City(105L, "Huye", 110.0),
//                new City(106L, "Nyabihu",40.0)));
//
        when(cityService.getAll()).thenReturn(Arrays.asList(new City(105L, "Huye", 29.0),
                new City(106L, "Nyabihu",40.0)));
    ...
    public void allCitiesWeather_GreaterThan10(){
        ...
        //Fails
//        when(cityService.getAll()).thenReturn(Arrays.asList(new City(105L, "Huye", 2.0),
//                new City(106L, "Nyabihu",40.0)));

        when(cityService.getAll()).thenReturn(Arrays.asList(new City(105L, "Huye", 24.0),
                new City(106L, "Nyabihu",40.0)));
    ...
    public void musanzeAndKigaliContainedInCites(){
        when(cityService.getAll()).thenReturn(Arrays.asList(
                new City(105L, "Musanze", 24.0),
                new City(105L, "Kigali", 24.0),
                new City(106L, "Nyabihu",40.0)));
